...
![Alt text](Creating_human-like_text_with_AI/1.png)

2. I need A LinkedIn 'About me' description
   
![Alt text](Creating_human-like_text_with_AI/2.png)

3. I need A script for how i would introduce myself at a conference.

![Alt text](Creating_human-like_text_with_AI/3.png)

4. I need a  script on how I would explain what I do to a 5-year-old kid.

![Alt text](Creating_human-like_text_with_AI/4.png)
---
## > Given different information:

![Alt text](Creating_human-like_text_with_AI/1_prompt.png)
![Alt text](Creating_human-like_text_with_AI/1_result.png)

## > Received text regenerated using a prompt:
![Alt text](Creating_human-like_text_with_AI/2_prompt.png)
![Alt text](Creating_human-like_text_with_AI/2_result.png)

## > One more regeneration. Adding some more personalized info trying to fool AI checks.
![Alt text](Creating_human-like_text_with_AI/3_prompt.png)
![Alt text](Creating_human-like_text_with_AI/3_result.png)
...
![Alt text](Creating_human-like_text_with_AI/5_AI_eval.png)

2. Same results - Ai models say that text is human written.
![Alt text](Creating_human-like_text_with_AI/6_AI_eval.png)

3. Few models identify that text is generated by AI.
![Alt text](Creating_human-like_text_with_AI/7_AI_eval.png)

4. Two out of 5 compared models identify text as AI generated. An one "Mistral" got broken :D even after repeated prompt.
![Alt text](Creating_human-like_text_with_AI/8_AI_eval.png)
![Alt text](Creating_human-like_text_with_AI/9_AI_eval_repeat.png)
